...
MN.station[ , .N , .(DOW, LatitudeMeasure, LongitudeMeasure) ][N>1 , .N]
MN.station[!is.na(DOW) , length(unique(LatitudeMeasure)) , .(DOW) ][ ,summary(V1) ,]
# NOt using these now, buyt might need to...
